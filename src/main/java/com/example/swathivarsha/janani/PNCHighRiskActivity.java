...
public class PNCHighRiskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pnchigh_risk);
        ...
        mListView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(PNCHighRiskActivity.this);
                alertDialog.setTitle("High Risk Patient");

                // display each baby's data in this alert box


                alertDialog.setIcon(R.drawable.ic_flower);
